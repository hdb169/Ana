...
void piplus_hgcer_eff_Binerr(){//pos = +;neg =neg, posneg = +/- both
  ...
  TH1F *pmom = new TH1F("pmom","Momentum (+VE 0.5<RF<0.9);Momentum (GeV);Entries", 100, bin_mom_lo, bin_mom_hi);
  TH1F *hctime_acc_pre = new TH1F("hctime_acc_pre","Ctime (+VE 0.5<RF<0.9);Ctime (ns);Entries", 160,20,80);
  TH1F *hctime_acc = new TH1F("hctime_acc","Ctime (+VE 0.5<RF<0.9);Ctime (ns);Entries", 160,20,80);
  TH1F *hctime_coin = new TH1F("hctime_coin","Ctime (+VE 0.5<RF<0.9);Ctime (ns);Entries ", 160,20,80);
  ...
  TProfile2D * xy_vs_npe_grcut_with_hole = new TProfile2D("xy_vs_npe_grcut_with_hole","+VE 0.5<RF<0.9: X vs Y  vs NPE (hole present, No Cer Cut);P.hgcer.yAtCer;P.hgcer.xAtCer;NPESUM", 300, -50, 50, 300, -50, 50, 0, 35);
  ...
  TH1F * htotal_mom_before_remove_region_acc  = new TH1F( "htotal_mom_before_remove_region_acc","Total before hole removed (Mom); Momuntum (+VE 0.5<RF<0.9); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_before_remove_region_acc  = new TH1F( "hpass_mom_before_remove_region_acc","Passed before hole removed (Mom); Momuntum (+VE 0.5<RF<0.9); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * htotal_mom_after_remove_region_acc  = new TH1F( "htotal_mom_after_remove_region_acc","Total after hole removed (Mom); Momuntum (+VE 0.5<RF<0.9); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_after_remove_region_acc  = new TH1F( "hpass_mom_after_remove_region_acc","Passed after hole removed (Mom); Momuntum (+VE 0.5<RF<0.9); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 


  TH1F * htotal_mom_before_remove_region_coin  = new TH1F( "htotal_mom_before_remove_region_coin","Total before hole removed (Mom); Momuntum (+VE 0.5<RF<0.9); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_before_remove_region_coin  = new TH1F( "hpass_mom_before_remove_region_coin","Passed before hole removed (Mom); Momuntum (+VE 0.5<RF<0.9); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * htotal_mom_after_remove_region_coin  = new TH1F( "htotal_mom_after_remove_region_coin","Total after hole removed (Mom); Momuntum (+VE 0.5<RF<0.9); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_after_remove_region_coin  = new TH1F( "hpass_mom_after_remove_region_coin","Passed after hole removed (Mom); Momuntum (+VE 0.5<RF<0.9); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 


  TH1F * heff  = new TH1F( "heff","Passed over total after hole removed (Mom); Momuntum (+VE 0.5<RF<0.9); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 

  TH1F * htotal_mom_before_remove_region_clean  = new TH1F( "htotal_mom_before_remove_region_clean","Total before hole removed (Mom); Momuntum (+VE 0.5<RF<0.9); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_before_remove_region_clean  = new TH1F( "hpass_mom_before_remove_region_clean","Passed before hole removed (Mom); Momuntum (+VE 0.5<RF<0.9); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * htotal_mom_after_remove_region_clean  = new TH1F( "htotal_mom_after_remove_region_clean","Total after hole removed (Mom); Momuntum (+VE 0.5<RF<0.9); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_after_remove_region_clean  = new TH1F( "hpass_mom_after_remove_region_clean","Passed after hole removed (Mom); Momuntum (+VE 0.5<RF<0.9); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  ...
  hpass_mom_hole_acc_1peak->SetTitle("Passed before hole removed (Mom): 4 Acc Plots (+VE 0.5<RF<0.9)");
  c->cd(2);
  ...
  c1->SaveAs("pdf/base_plots_pos_binerr.pdf");
  c2->SaveAs("pdf/eff_plots_pos_binerr.pdf");
  c3->SaveAs("pdf/finaleff_pos_binerr.pdf");
  c->SaveAs("pdf/accidental_only_pos_binerr.pdf");
  ...
  c5->SaveAs("pdf_bin/eff_binerr_piplus.pdf");
  /*
