...
void piminus_hgcer_eff(){//pos = +;neg =neg, posneg = +/- both
  ...
  gStyle->SetErrorX(0);
  gStyle->SetOptStat(0);
 ofstream txtfile("txtfile/efficiency_neg.txt");
 ...
 double bin_mom = 7;
  ...
  double mom_lo = 2.7;// 3.0;
  double mom_hi = 4.7;//4.5;
  ...
  TH1F *pmom = new TH1F("pmom","Momentum (-VE, 0.5<RF<1.5);Momentum (GeV);Entries", 100, bin_mom_lo, bin_mom_hi);
  TH1F *hctime_acc_pre = new TH1F("hctime_acc_pre","Ctime (-VE, 0.5<RF<1.5);Ctime (ns);Entries", 160,20,80);
  TH1F *hctime_acc = new TH1F("hctime_acc","Ctime (-VE, 0.5<RF<1.5);Ctime (ns);Entries", 160,20,80);
  TH1F *hctime_coin = new TH1F("hctime_coin","Ctime (-VE, 0.5<RF<1.5);Ctime (ns);Entries ", 160,20,80);
  ...
  TProfile2D * xy_vs_npe_grcut_with_hole = new TProfile2D("xy_vs_npe_grcut_with_hole","-VE, 0.5<RF<1.5: X vs Y  vs NPE (hole present, No Cer Cut);P.hgcer.yAtCer;P.hgcer.xAtCer;NPESUM", 300, -50, 50, 300, -50, 50, 0, 35);
  ...
  TH1F * htotal_mom_before_remove_region_acc  = new TH1F( "htotal_mom_before_remove_region_acc","Total before hole removed (Mom); Momuntum (-VE, 0.5<RF<1.5); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_before_remove_region_acc  = new TH1F( "hpass_mom_before_remove_region_acc","Passed before hole removed (Mom); Momuntum (-VE, 0.5<RF<1.5); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * htotal_mom_after_remove_region_acc  = new TH1F( "htotal_mom_after_remove_region_acc","Total after hole removed (Mom); Momuntum (-VE, 0.5<RF<1.5); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_after_remove_region_acc  = new TH1F( "hpass_mom_after_remove_region_acc","Passed after hole removed (Mom); Momuntum (-VE, 0.5<RF<1.5); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 


  TH1F * htotal_mom_before_remove_region_coin  = new TH1F( "htotal_mom_before_remove_region_coin","Total before hole removed (Mom); Momuntum (-VE, 0.5<RF<1.5); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_before_remove_region_coin  = new TH1F( "hpass_mom_before_remove_region_coin","Passed before hole removed (Mom); Momuntum (-VE, 0.5<RF<1.5); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * htotal_mom_after_remove_region_coin  = new TH1F( "htotal_mom_after_remove_region_coin","Total after hole removed (Mom); Momuntum (-VE, 0.5<RF<1.5); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_after_remove_region_coin  = new TH1F( "hpass_mom_after_remove_region_coin","Passed after hole removed (Mom); Momuntum (-VE, 0.5<RF<1.5); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 

  TH1F * htotal_mom_before_remove_region_clean  = new TH1F( "htotal_mom_before_remove_region_clean","Total before hole removed (Mom); Momuntum (-VE, 0.5<RF<1.5); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_before_remove_region_clean  = new TH1F( "hpass_mom_before_remove_region_clean","Passed before hole removed (Mom); Momuntum (-VE, 0.5<RF<1.5); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * htotal_mom_after_remove_region_clean  = new TH1F( "htotal_mom_after_remove_region_clean","Total after hole removed (Mom); Momuntum (-VE, 0.5<RF<1.5); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_after_remove_region_clean  = new TH1F( "hpass_mom_after_remove_region_clean","Passed after hole removed (Mom); Momuntum (-VE, 0.5<RF<1.5); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 

  TH1F *hEff = new TH1F("hEff","Hgcer Efficiency;Momentum (-VE, 0.5<RF<1.5) GeV;Efficiency", bin_mom, bin_mom_lo, bin_mom_hi);
  ...
  remove_region = central_hole && right_or_left_of_hole;//ok
    ...
    data_cut =  pcaletottracknorm <pcal_pion    &&  mom >= mom_lo  &&mom <= mom_hi && rftime < rf_hi_pim ;
  ...
  hpass_mom_hole_acc_1peak->SetTitle("Passed before hole removed (Mom): 4 Acc Plots (-VE, 0.5<RF<1.5)");
  c->cd(2);
...
TGraphErrors* gr = new TGraphErrors();
  ...
  c5->SaveAs("pdf_bin/eff_binerr_piminus.gif");
  c5->SaveAs("pdf_bin/eff_binerr_piminus.pdf");
  ...
  c1->SaveAs("pdf/base_plots_neg.pdf");
  c2->SaveAs("pdf/eff_plots_neg.pdf");
  c3->SaveAs("pdf/finaleff_plots_neg.pdf");
  c->SaveAs("pdf/accidental_only_neg.pdf");
