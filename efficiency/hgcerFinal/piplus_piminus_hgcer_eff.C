...
void piplus_piminus_hgcer_eff(){//pos = +;neg =neg, posneg = +/- both
  ...
  TChain *tt = new TChain("T");
   ...
   tt->Add("/home/hdbhatt/ROOTfiles/oct28_hgceff/giant_posneg_gt3p6GeV.root");
  ...
  TH1F *pmom = new TH1F("pmom","Momentum (-VE+VE);Momentum (GeV);Entries", 100, bin_mom_lo, bin_mom_hi);
  TH1F *hctime_acc_pre = new TH1F("hctime_acc_pre","Ctime (-VE+VE);Ctime (ns);Entries", 160,20,80);
  TH1F *hctime_acc = new TH1F("hctime_acc","Ctime (-VE+VE);Ctime (ns);Entries", 160,20,80);
  TH1F *hctime_coin = new TH1F("hctime_coin","Ctime (-VE+VE);Ctime (ns);Entries ", 160,20,80);
  ...
  TProfile2D * xy_vs_npe_grcut_with_hole = new TProfile2D("xy_vs_npe_grcut_with_hole","-VE+VE: X vs Y  vs NPE (hole present, No Cer Cut);P.hgcer.yAtCer;P.hgcer.xAtCer;NPESUM", 300, -50, 50, 300, -50, 50, 0, 35);
  ...
  TH1F * htotal_mom_before_remove_region_acc  = new TH1F( "htotal_mom_before_remove_region_acc","Total before hole removed (Mom); Momuntum (-VE+VE); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_before_remove_region_acc  = new TH1F( "hpass_mom_before_remove_region_acc","Passed before hole removed (Mom); Momuntum (-VE+VE); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * htotal_mom_after_remove_region_acc  = new TH1F( "htotal_mom_after_remove_region_acc","Total after hole removed (Mom); Momuntum (-VE+VE); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_after_remove_region_acc  = new TH1F( "hpass_mom_after_remove_region_acc","Passed after hole removed (Mom); Momuntum (-VE+VE); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 


  TH1F * htotal_mom_before_remove_region_coin  = new TH1F( "htotal_mom_before_remove_region_coin","Total before hole removed (Mom); Momuntum (-VE+VE); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_before_remove_region_coin  = new TH1F( "hpass_mom_before_remove_region_coin","Passed before hole removed (Mom); Momuntum (-VE+VE); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * htotal_mom_after_remove_region_coin  = new TH1F( "htotal_mom_after_remove_region_coin","Total after hole removed (Mom); Momuntum (-VE+VE); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_after_remove_region_coin  = new TH1F( "hpass_mom_after_remove_region_coin","Passed after hole removed (Mom); Momuntum (-VE+VE); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 

  TH1F * htotal_mom_before_remove_region_clean  = new TH1F( "htotal_mom_before_remove_region_clean","Total before hole removed (Mom); Momuntum (-VE+VE); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_before_remove_region_clean  = new TH1F( "hpass_mom_before_remove_region_clean","Passed before hole removed (Mom); Momuntum (-VE+VE); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * htotal_mom_after_remove_region_clean  = new TH1F( "htotal_mom_after_remove_region_clean","Total after hole removed (Mom); Momuntum (-VE+VE); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 
  TH1F * hpass_mom_after_remove_region_clean  = new TH1F( "hpass_mom_after_remove_region_clean","Passed after hole removed (Mom); Momuntum (-VE+VE); Entries", bin_mom, bin_mom_lo, bin_mom_hi); 

  TH1F *hEff = new TH1F("hEff","Hgcer Efficiency;Momentum (-VE+VE) GeV;Efficiency", bin_mom, bin_mom_lo, bin_mom_hi);
  ...
  hpass_mom_hole_acc_1peak->SetTitle("Passed before hole removed (Mom): 4 Acc Plots (-VE+VE)");
  c->cd(2);
  ...
  c1->SaveAs("pdf/base_plots_negpos.pdf");
  c2->SaveAs("pdf/eff_plots_negpos.pdf");
  c3->SaveAs("pdf/finaleff_plots_negpos.pdf");
  c->SaveAs("pdf/accidental_only_negpos.pdf");
