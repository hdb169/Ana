...
for (int i = 0; i < scal_entries; i++) {
  ...
  /* hcurrent_bcmcut->Fill(current_bcmcut);//take Mean  */
  /* hcurrent_nobcmcut->Fill(current_nobcmcut);//take Mean */
 }
...
Double_t PTRIG3_Rate = tot_scal_cut_TRIG3/(tot_scal_cut_time*1000);
...
Double_t PTRIG4_Rate = tot_scal_cut_TRIG4/(tot_scal_cut_time*1000);
