...
TH1D *hist_pcal_aero_did_acc = new TH1D("hist_pcal_aero_did_acc", "hist_pcal_aero_did_acc",binzvalue, binzlo, binzhi);
TH1D *hist_pcal_aero_should_acc = new TH1D("hist_pcal_aero_should_acc", "hist_pcal_aero_should_acc",binzvalue, binzlo, binzhi);
TH1D *hist_pcal_aero_did_coin = new TH1D("hist_pcal_aero_did_coin", "hist_pcal_aero_did_coin",binzvalue, binzlo, binzhi);
TH1D *hist_pcal_aero_should_coin = new TH1D("hist_pcal_aero_should_coin", "hist_pcal_aero_should_coin",binzvalue, binzlo, binzhi);
TH1D *hist_pcal_aero_should_clean = new TH1D("hist_pcal_aero_should_clean", "hist_pcal_aero_should_clean",binzvalue, binzlo, binzhi);
TH1D *hist_pcal_aero_did_clean = new TH1D("hist_pcal_aero_did_clean", "hist_pcal_aero_did_clean",binzvalue, binzlo, binzhi);
