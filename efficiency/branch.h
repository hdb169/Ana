...
tt->SetBranchAddress("P.dc.x_fp", &track_x_fp);
tt->SetBranchAddress("P.dc.y_fp", &track_y_fp);
tt->SetBranchAddress("P.dc.xp_fp", &track_xp_fp);
tt->SetBranchAddress("P.dc.yp_fp", &track_yp_fp);
