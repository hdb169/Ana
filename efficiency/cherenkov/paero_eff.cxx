...
#define NRUNS 22
void aero_efftry(){//has hgcer cut
...
#include "scaler_analysis.h"
	...
	/////////////////////////////////////////////////actual eff is here================
       	...
       	if(runs[r]<6000){
	  base_cut_aero = hdelta> -8 && hdelta < 8 && hhodstarttime ==1 && hdipole==1 &&  hcernpe > 10 && pdelta >-10 && pdelta < 20 &&  phodstarttime == 1 && pdipole ==1 && eventtype > 3 && mod4_pioncut  && xptaryptar_cut && pcaletottrack < 0.5 && hcaletottrack > 1.2 ; 
	}
	if(runs[r]>6000&&runs[r]<7593){
	...
	if(runs[r]>7593){
	  base_cut_aero = hdelta> -8 && hdelta < 8 && hhodstarttime ==1 && hdipole==1 &&  hcernpe > 10 && pdelta >-10 && pdelta < 20 &&  phodstarttime == 1 && pdipole ==1 && eventtype > 3 && mod4_pioncut  && xptaryptar_cut && pcaletottrack < 0.65 && hcaletottrack > 0.8 &&  ngcer < ngc; 
	}
	...
	if(runs[r] < 6000){
	  paero_did_cut_acc = paero_should_cut_acc && paero > 2.5;
	  paero_did_cut_coin = paero_should_cut_coin && paero > 2.5;
	}

	if(runs[r] > 6000){
	  paero_did_cut_acc = paero_should_cut_acc && paero > 4.0;
	  paero_did_cut_coin = paero_should_cut_coin && paero > 4.0;
	}
